        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    //var_dump($trackis);
                    if($trackis == ""){
                    $trackis = "https://2025.smallsateurope.com/agenda-main/";
                    }
                        ...
                        <span class="speakers-thumbs">
                            ...
                            if (!empty($speakers_list)) {
                                foreach ($speakers_list as $speaker_id) {
                                    ...
                                    ?>
                                    <a href = "<?php echo get_permalink($speaker_id); ?>" class="speaker<?php if ($post_meta_data['speaker_keynote'][0] == 1) echo ' featured'; ?>">
