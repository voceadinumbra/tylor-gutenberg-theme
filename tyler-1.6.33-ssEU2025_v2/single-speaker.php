...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <div class="heading">
            <div class="container">
                <h1>
                    <?php 
						the_post_thumbnail('tyler_speaker', array('title' => get_the_title(), 'class' => 'img-speaker'));
					?>
					<div class="speaker_details">
						...
						<div class="speaker_company">
							<?php echo $post_meta_data['company_name'][0]; ?>
						</div>
					</div>
                </h1>
                <div class="nav">
                    ...
                    <?php //if (!empty($full_speakers_url)) { ?>
                        <a href="<?php echo home_url("/speakers"); ?>" title="<?php _e('All', 'tyler'); ?>"><i class="icon-th-large"></i></a>
                    <?php //} ?>
