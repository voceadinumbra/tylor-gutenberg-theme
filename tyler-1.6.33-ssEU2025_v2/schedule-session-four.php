<?php
/*
 * Template Name: Schedule Session Four
 *
 * @package WordPress
 * @subpackage Tyler
 */
...
<?php
$session_dates = sandeep_get_session_dates("sessionfour");
$session_tracks = sandeep_get_terms_for_post_type('session-track',"sessionfour");
$session_locations = sandeep_get_terms_for_post_type('session-location',"sessionfour");
