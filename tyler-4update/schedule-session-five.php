...
<?php
$session_dates = sandeep_get_session_dates("sessionfive");
$session_tracks = sandeep_get_terms_for_post_type('session-track',"sessionfive");
$session_locations = sandeep_get_terms_for_post_type('session-location',"sessionfive");
