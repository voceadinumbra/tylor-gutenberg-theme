<?php
/*
 * Template Name: Schedule Session Two
 *
 * @package WordPress
 * @subpackage Tyler
 */
...
<?php
$session_dates = sandeep_get_session_dates("sessiontwo");
$session_tracks = sandeep_get_terms_for_post_type('session-track',"sessiontwo");
$session_locations = sandeep_get_terms_for_post_type('session-location',"sessiontwo");
